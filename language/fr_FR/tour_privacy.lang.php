...
$lang['privacy_stp22'] = '<em>Pour les utilisateurs avancés</em> <br><br> Dans Piwigo, vous pouvez protéger les photos originales en utilisant votre configuration locale. Utilisez la variable $conf[\' original_url_protection\']: par défaut vide, vous choisissez la valeur "images" pour protéger uniquement les photos ou "toutes" pour protéger également tous les types de médias, ce qui peut consommer beaucoup de ressources processeur ou qui pourrait tout simplement ne pas fonctionner sur votre serveur.<br><br>Cette option fonctionne pour le contenu public et privé. Cette option vous oblige à refuser les accès aux dossiers /upload et /galleries, en utilisant un fichier .htaccess (un fichier texte avec "Deny from all" comme contenu) ou à paramétrer dans la configuration du serveur web.<br><br>Ce faisant, veuillez noter que les noms de fichiers de photos téléchargées en utilisant une autre méthode que le FTP sont rendus <b>aléatoires</b>, de sorte qu\'ils sont impossibles à deviner : ce nom de fichier ainsi que le chemin vers la photo originale ne peuvent être devinés. Le visiteur n\'a ainsi accès qu\'à un redimensionnement de cette photo, comme la miniature. $conf[\'original_url_protection\'] + protection des dossiers /upload et /galeries sont destinés à éviter l\'accès aux originaux.';
