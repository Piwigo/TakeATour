...
$lang['first_contact_stp14'] = 'Wir sehen hier die Bearbeitungs-Seite eines Bildes. Diese Seite ist von hier aus erreichbar, aber auch von der öffentlichen Seite, wenn du als Administrator angemeldet bist. Klicke auf Bearbeiten oder Nächste';
...
$lang['first_contact_stp1'] = 'Hallo! Ich werde dein Begleiter sein, um Piwigo zu entdecken. Bitte folge meinen Anweisungen und klicke auf "Nächste" (oder benutze die Pfeile auf der Tastatur) zum Navigieren. Wenn du beim Rundgang zur Verwaltungs-Seite gehst, wirst du danach auf die aktuelle Seite der Tour umgeleitet. Falls du stecken bleibst und die Tour nicht beenden kannst, gehe zu <em>Plugins » Mache  eine Tour</em>, um die Tour zu beenden. <br> Lass uns beginnen, indem wir Bilder hinzufügen!';
$lang['first_contact_stp16'] = 'Hier kannst du Bilder den Alben hinzufügen oder aus diesen entfernen. Die Verknüpfung ist virtuell, keine Bilder werden physikalisch verschoben.';
...
$lang['first_contact_stp43'] = 'Diese Tour war ziemlich lang, wir haben aber nur einen kleinen Teil von dem gesehen, wie mächtig Piwigo ist. Alles hat ein Ende, diese Übersicht ist nun beendet. <br> Du kannst viel tiefer in die Eigenschaften von Piwigo einsteigen, indem du eine andere Tour unternimmst oder unsere Dokumentation auf der Website piwigo.org liest.';
...
$lang['first_contact_stp38'] = 'Plugins sind sehr einfache Möglichkeiten, dein Piwigo anzupassen. Sie können fast alles, was du dir vorstellen kannst: von kleinen zusätzlichen Texten bis zu umfangreichen Funktionen, wie z. B. das Community Plugin, dass es auch normalen Benutzern (Nicht- Administratoren) erlaubt, Bilder hochzuladen.';
...
$lang['first_contact_stp21'] = 'Der nächste Reiter ist eine Seite auf der du jedes virtuelle Album bewegen kannst.<br>Der Permalinks Reiter existiert, um für Alben feste Adressen (URLs) festzulegen.<br>Aber lass uns erst ein Album editieren: Klicke auf <em>Bearbeiten</em>.';
