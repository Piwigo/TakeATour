...
$lang['first_contact_stp41'] = 'Op het laatste tabblad kun je zien, welke plug-ins beschikbaar zijn voor jouw versie van Piwigo. Er zijn meer dan 100 plug-ins beschikbaar!';
$lang['first_contact_stp40'] = 'Ik ben het! Schakel mij nu niet uit, maar je kunt hier zien, dat je een geactiveerde plug-in, in- en uit kunt schakelen.';
$lang['first_contact_title22'] = 'Wijzig Album';
$lang['first_contact_stp15'] = 'Op die pagina kunt je alle eigenschappen van een foto bewerken, bijvoorbeeld ...';
$lang['first_contact_stp11'] = 'Zo kunt je hier vandaan één of meerdere foto\'s selecteren.';
...
$lang['first_contact_stp32'] = 'Bewaar nu jouw wijzigingen';
$lang['first_contact_stp30'] = 'We beginnen met het veranderen van de titel';
$lang['first_contact_title38'] = 'Plug-ins';
$lang['first_contact_title39'] = 'Plug-ins';
...
$lang['first_contact_title3'] = 'Foto toevoegen';
...
$lang['first_contact_stp1'] = 'Hallo! Ik ben je gids om Piwigo te ontdekken. Volg mijn instructies en klik op Volgende om te navigeren (of gebruik de pijltjes van jouw toetsenbord). Als je tijdens de rondleiding naar een andere pagina van het beheer gaat, word je doorgestuurd naar de huidige pagina van de Rondleiding. Als je vast komt te zitten en de rondleiding niet kunt afronden ga je naar <em>Plugins >> Neem een Rondleiding</em>. Hiermee beëindig je de rondleiding.<br>Laten we beginnen met het toevoegen van foto\'s!';
$lang['first_contact_stp3'] = 'Dit eerste tabblad is om foto\'s direct vanuit de browser toe te voegen. Met behulp van de andere tabs kun je andere manieren gebruiken om jouw foto\'s te uploaden.';
...
$lang['first_contact_stp20'] = 'Als jouw muis over een album gaat, verschijnt er informatie en links. Als je het album sleept en loslaat -een blok met afgeronde randen-, verander je het van positie. Vervolgens kun je handmatige volgorde bewaren of de hele actie annuleren.';
...
$lang['first_contact_stp7'] = 'Hier is een samenvatting van jouw ge-uploade foto\'s. Merk op dat Piwigo uit zichzelf miniaturen heeft gemaakt. Nu kun je meer foto\'s toevoegen via de link onderaan. Je kunt de eigenschappen van een foto bewerken door erop te klikken. Je kunt ook klikken op de Bulk Beheerder om je ge-uploade foto\'s te beheren.';
...
$lang['first_contact_stp39'] = 'Op de eerste pagina staan alle geïnstalleerde plug-ins. Bovenaan staan de ge-activeerde plug-ins die op dit moment draaien. Beneden op de pagina staan de plug-ins die wel zijn geïnstalleerd in de plug-ins-map, maar uitgeschakeld zijn. Met de verwijdering van een plug-in verwijder je alle hiermee verbonden onderdelen (bestanden, opties, etc.). Voor de meeste plug-ins geldt dat bij uitschakeling ervan de gegevens behouden blijven.';
$lang['first_contact_stp38'] = 'Plugins vormen een erg makkelijke manier om jouw Piwigo naar jouw persoonlijke smaak in te richten. Ze kunnen bijna alles wat je je maar kunt voorstellen. Van kleine tekstuele toevoegingen tot volledige onderdelen, zoals bv. de Community-plug-in die niet-beheerders toestaat om te uploaden zonder naar de beheerderspagina te gaan. ';
$lang['first_contact_stp37'] = 'Nieuwe thema\'s kun je direct downloaden/installeren via de tab "Nog niet geïnstalleerde thema\'s". Alleen de compatibele thema\'s met jouw Piwigo-versie worden getoond.<br>We gaan nu de Plugins bekijken! Klik op Plugin->Beheer.';
...
$lang['first_contact_stp21'] = 'De volgende tab is een pagina waar je elk virtiueel album kunt verplaatsen<br>De permanente link tab is om een precieze url voor een album te maken.<br>Maar laten we een album wijzigen: klik op Wijzig een album';
$lang['first_contact_stp5'] = 'Klik de toets om geselecteerde foto\'s te versturen, of sleep en verplaats jouw bestanden.';
$lang['first_contact_stp35'] = 'Zet jouw favoriete thema als standaard thema.';
...
$lang['first_contact_stp18'] = 'Laten we eens kijken hoe we albums kunnen beheren. Klik <em> op Album » Manage</em> of klik Volgende';
