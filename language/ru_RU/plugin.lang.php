...
$lang['2.8 Tour'] = 'Тур по Piiwigo 2.8';
$lang['2_8_0_descrp'] = 'Откройте новые возможности Piiwigo 2.8. Читайте подробности по адресу <a href="%s">Заметки к релизу</a>.';
$lang['manage_albums_descrp'] = 'Иерархия Ваших альбомов - это структура Вашей галереи. Изучите, как можно обращаться с ними и редактировать их свойства.';
$lang['plugins_descrp'] = 'Плагины - это ключевые фишки Piwigo. Активируйте различнейшие функции в несколько кликов мышкой и делайте Piwigo таким, каким захотите.';
$lang['config_descrp'] = 'Устанавливайте свои настройки Piwigo. Откройте менеджер тем и выберите внешний вид Вашего Piwigo.';
$lang['config_name'] = 'Конфигурация';
$lang['edit_photos_descrp'] = 'Изображения - это ключевые элементы Вашего Piwigo. Посмотрите, как Вы можете менять их свойства - поодиночке или "оптом".';
$lang['edit_photos_name'] = 'Редактировать изображения';
$lang['manage_albums_name'] = 'Управление альбомами';
$lang['plugins_name'] = 'Плагины';
$lang['2_9_0_descrp'] = 'Откройте для себя некоторые новые фишки Piwigo 2.9. Детали можно узнать в заметках к <a href="%s">релизу</a>.';
$lang['2_9_0_name'] = 'Тур 2.9';